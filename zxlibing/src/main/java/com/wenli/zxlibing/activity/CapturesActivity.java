package com.wenli.zxlibing.activity;
...
import com.wenli.zxlibing.decoding.CaptureActivityHandler;
import com.wenli.zxlibing.decoding.InactivityTimer;
import com.wenli.zxlibing.decoding.RGBLuminanceSource;
import com.wenli.zxlibing.util.BitmapUtil;
import com.wenli.zxlibing.util.Constant;
import com.wenli.zxlibing.view.ViewfinderView;
 ...
 * @author Ryan.Tang
 */
public class CapturesActivity extends AppCompatActivity implements Callback {
...
//		cancelScanButton = (Button) this.findViewById(R.id.btn_cancel_scan);
    ...
    private void handleAlbumPic(Intent data) {
        ...
        mProgress = new ProgressDialog(CapturesActivity.this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (result != null) {
                    ...
                    CapturesActivity.this.setResult(RESULT_OK, resultIntent);
                    finish();
                } else {
                    Toast.makeText(CapturesActivity.this, "识别失败", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//		});
    ...
    public void handleDecode(Result result, Bitmap barcode) {
        ...
        if (TextUtils.isEmpty(resultString)) {
            Toast.makeText(CapturesActivity.this, "Scan failed!", Toast.LENGTH_SHORT).show();
        } else {
            Intent resultIntent = new Intent();
            Bundle bundle = new Bundle();
    ...
    private View.OnClickListener flashListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            try {
                ...
                if(!isSuccess){
                    Toast.makeText(CapturesActivity.this, "暂时无法开启闪光灯", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (isFlashOn) {
                    // 关闭闪光灯
