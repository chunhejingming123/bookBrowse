...
public class BookSucessDialoge implements View.OnClickListener {
    private Dialog mDialoge;
    private SoftReference<Activity> soft = null;
    private Button btnlogin;
    private ImageView ivClose;

    public BookSucessDialoge(Activity mActivity) {
    ...
    private void initView() {
        View view = LayoutInflater.from(soft.get()).inflate(R.layout.dialoge_book_sucess, null);
