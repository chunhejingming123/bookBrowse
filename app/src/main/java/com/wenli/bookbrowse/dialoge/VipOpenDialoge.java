...
public class VipOpenDialoge implements View.OnClickListener {
    private Dialog mDialoge;
    private SoftReference<Activity> soft = null;
    private Button btnlogin;
    private ImageView ivClose;

    public VipOpenDialoge(Activity mActivity) {
    ...
    private void initView() {
        View view = LayoutInflater.from(soft.get()).inflate(R.layout.dialoge_vip_open, null);
        mDialoge.setContentView(view);

        ivClose = view.findViewById(R.id.ivClose);
        btnlogin = view.findViewById(R.id.btnOpen);
