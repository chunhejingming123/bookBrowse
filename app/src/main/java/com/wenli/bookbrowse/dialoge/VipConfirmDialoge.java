...
public class VipConfirmDialoge implements View.OnClickListener {
    private Dialog mDialoge;
    private SoftReference<Activity> soft = null;
    private Button btnOpem;
    private ImageView ivClose;
    private TextView tvConfirmTip;

    public VipConfirmDialoge(Activity mActivity) {
    ...
    private void initView() {
        View view = LayoutInflater.from(soft.get()).inflate(R.layout.dialoge_vip_confirm_open, null);
        mDialoge.setContentView(view);
        tvConfirmTip = view.findViewById(R.id.tvConfirmTip);
        ivClose = view.findViewById(R.id.ivClose);
        btnOpem = view.findViewById(R.id.btnOpen);
        ivClose.setOnClickListener(this);
        btnOpem.setOnClickListener(this);
    ...
    public void showDialoge(String tip) {
        if (mDialoge != null) {
            mDialoge.show();
            if (!TextUtils.isEmpty(tip)) {
                tvConfirmTip.setText(tip);
            }
        }
    }
